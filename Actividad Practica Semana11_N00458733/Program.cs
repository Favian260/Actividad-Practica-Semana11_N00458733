...
namespace Actividad_2_Funal_S11
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.Write($"\nIngrese el coste del libro {i + 1}, este debe ser necesariamente decimal: ");
                while ((!double.TryParse(Console.ReadLine(), out precio[i]) || precio[i] % 1 == 0))
                {
        ...
        static void BuscarNombreYModificarPrecio(ref string[] nombre, ref double[] precio, int cantidadDeNumeros)
        {
            ...
            for (int i = 0; i < nombre.Length; i++)
            {
                ...
                {
                    contador++;
                    Console.WriteLine($"El libro de orden {contador} con el nombre buscado es el producto numero {i + 1} de la lista.");
